...
function sendImage(message, client, attempt) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    imgUrl = _a.sent();
                    return [4 /*yield*/, client.sendFileFromUrl(message.chatId, imgUrl, imgUrl, '')];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 3:
                    ...
                    return [4 /*yield*/, sendImage(message, client, attempt)];
                case 4:
                    _a.sent();
                    _a.label = 5;
